...
**Evaluation Timestamp:** 2026-09-20T18:23:44.541Z  
**Total Test Cases:** 20  
...
| `eval-004` | emergency_triage | "Ate peanuts, now lips are swelling up and thr..." | ✅ PASS | 0ms | Matched: Dermatology (Expected: Dermatology) |
...
| `eval-007` | specialty_routing | "Severe burning sensation behind breastbone af..." | ✅ PASS | 1ms | Matched: Gastroenterology (Expected: Gastroenterology) |
...
| `eval-015` | rag_retrieval | "What are the AAP criteria for fever in an inf..." | ✅ PASS | 1ms | Citations: 3 sources matched (Confidence: 0.869) |
